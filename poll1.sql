...
(3, 'kk', 'kill', 'bill@concil.com', '29e457082db729fa1059d4294ede3909'),
...
INSERT INTO `images` (`image_id`, `c_name`, `image`, `email`, `password`) VALUES
(1, 'Kimani', '', 'kahiga@gmail.com', '547da2b03f947606f1d06a8dec093e64'),
(2, 'MacDonald', '', 'mcbcrue08@gmail.com', '14b876400a7ae986df9b17fbaffb9eca'),
(3, 'test', '', 'test@example.com', '1234'),
(5, 'Ajay', '', 'ajaychaubey95@gmail.com', '202cb962ac59075b964b07152d234b70'),
(6, 'anil', '', 'anil@gmail.com', '202cb962ac59075b964b07152d234b70');
...
ALTER TABLE `images`
  MODIFY `image_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
